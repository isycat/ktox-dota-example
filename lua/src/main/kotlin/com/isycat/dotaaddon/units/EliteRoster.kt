...
/**
 * One kind of elite: the custom unit it spawns plus its combat kit. This is the RUNTIME roster
 ...
 * list in [EliteUnits] (a `@KvSource` file), so adding a kind here + a row there is all it takes. Display
 * names are standard unit-name localization: a `resource/addon_english.txt` entry keyed by [unitName].
 */
